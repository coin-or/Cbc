   ...
   void addCbcSolverKwdParams(CoinParamVec &parameters, CbcSolverSettings *cbcSettings)
{
  ...
  parameters[CbcSolverParam::ALLCOMMANDS].setup("allC!ommands",
                             ...
                             CoinParam::displayPriorityNone);
  parameters[CbcSolverParam::ALLCOMMANDS].appendKwd("more", CbcSolverParam::CMMore);
  parameters[CbcSolverParam::ALLCOMMANDS].appendKwd("all", CbcSolverParam::CMAll);
  ...
  parameters[CbcSolverParam::CLQSTRENGTHENING].appendKwd("off", CbcSolverParam::ClqStrOff);
  parameters[CbcSolverParam::CLQSTRENGTHENING].appendKwd("before", CbcSolverParam::ClqStrBefore);
  ...
  parameters[CbcSolverParam::BRANCHPRIORITY].appendKwd("pri!orities", CbcSolverParam::BPCost);
  parameters[CbcSolverParam::BRANCHPRIORITY].appendKwd("column!Order", CbcSolverParam::BPOrder);
  ...
  parameters[CbcSolverParam::CUTOFFCONSTRAINT].appendKwd("on", CbcSolverParam::COOn);
  parameters[CbcSolverParam::CUTOFFCONSTRAINT].appendKwd("variable", CbcSolverParam::COVariable);
  parameters[CbcSolverParam::CUTOFFCONSTRAINT].appendKwd("forcevariable", CbcSolverParam::COForceVariable);
  parameters[CbcSolverParam::CUTOFFCONSTRAINT].appendKwd("conflict", CbcSolverParam::COConflict);
  ...
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd("fewest", CbcSolverParam::NSFewest);
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd("depth", CbcSolverParam::NSDepth);
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd("upfewest", CbcSolverParam::NSUpFewest);
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd("downfewest", CbcSolverParam::NSDownFewest);
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd("updepth", CbcSolverParam::NSUpDepth);
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd("downdepth", CbcSolverParam::NSDownDepth);
  ...
  parameters[CbcSolverParam::ORBITAL].appendKwd("slowish", CbcSolverParam::OBSlowish);
  parameters[CbcSolverParam::ORBITAL].appendKwd("strong", CbcSolverParam::OBStrong);
  parameters[CbcSolverParam::ORBITAL].appendKwd("force", CbcSolverParam::OBForce);
  parameters[CbcSolverParam::ORBITAL].appendKwd("simple", CbcSolverParam::OBSimple);
  parameters[CbcSolverParam::ORBITAL].appendKwd("moreprinting", CbcSolverParam::OBMorePrinting);
  ...
  parameters[CbcSolverParam::PREPROCESS].appendKwd("save", CbcSolverParam::IPPSave);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("equal", CbcSolverParam::IPPEqual);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("sos", CbcSolverParam::IPPSOS);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("trysos", CbcSolverParam::IPPTrySOS);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("equalall", CbcSolverParam::IPPEqualAll);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("strategy", CbcSolverParam::IPPStrategy);
  ...
  parameters[CbcSolverParam::SOSPRIORITIZE].appendKwd("high", CbcSolverParam::SOSHigh);
  parameters[CbcSolverParam::SOSPRIORITIZE].appendKwd("low", CbcSolverParam::SOSLow);
  parameters[CbcSolverParam::SOSPRIORITIZE].appendKwd("orderhigh", CbcSolverParam::SOSOrderHigh);
  parameters[CbcSolverParam::SOSPRIORITIZE].appendKwd("orderlow", CbcSolverParam::SOSOrderLow);
  ...
  parameters[CbcSolverParam::STRATEGY].appendKwd("easy", CbcSolverParam::StrategyEasy);
  parameters[CbcSolverParam::STRATEGY].appendKwd("aggressive", CbcSolverParam::StrategyAggressive);
  ...
  parameters[CbcSolverParam::TIMEMODE].appendKwd("elapsed", CbcSolverParam::ClockElapsed);
...
int pushCbcSolverBoolParam(CoinParam &param)
{
  ...
  CbcSolverParam::OnOffMode mode = static_cast<CbcSolverParam::OnOffMode>(cbcParam.modeVal());
  CbcSolverParam::CbcSolverParamCode code = cbcParam.paramCode();
...
int pushCbcSolverHeurParam(CoinParam &param)
{
  ...
  // This is ugly, get keyword and set parameter with it instead.
  CbcSolverParam::HeurMode mode = static_cast<CbcSolverParam::HeurMode>(cbcParam.modeVal());
  CbcSolverParam::CbcSolverParamCode code = cbcParam.paramCode();
...

{
  ...
  CbcSolverParam::CGMode mode = static_cast<CbcSolverParam::CGMode>(cbcParam.modeVal());
  CbcSolverParam::CbcSolverParamCode code = cbcParam.paramCode();
  /*
