...
void addCbcSolverStrParams(CoinParamVec &paramVec, CbcSolverSettings *cbcSettings);
void addCbcSolverHelpParams(CoinParamVec &paramVec, CbcSolverSettings *cbcSettings);
void addCbcSolverActionParams(CoinParamVec &paramVec, CbcSolverSettings *cbcSettings);
void addCbcSolverKwdParams(CoinParamVec &paramVec, CbcSolverSettings *cbcSettings);
void addCbcSolverDblParams(CoinParamVec &paramVec, CbcSolverSettings *cbcSettings);
void addCbcSolverIntParams(CoinParamVec &paramVec, CbcSolverSettings *cbcSettings);
void addCbcSolverBoolParams(CoinParamVec &paramVec, CbcSolverSettings *cbcSettings);
void addCbcSolverCutParams(CoinParamVec &paramVec, CbcSolverSettings *cbcSettings);
void addCbcSolverHeurParams(CoinParamVec &paramVec, CbcSolverSettings *cbcSettings);
