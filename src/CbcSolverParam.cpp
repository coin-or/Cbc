...
void addCbcSolverParams(CoinParamVec &parameters,
  ...
  for (int code = CbcSolverParam::CBCSOLVER_FIRSTPARAM + 1;
       code < CbcSolverParam::CBCSOLVER_LASTPARAM; code++) {
    CoinParam &param = parameters[code];
    static_cast<CbcSolverParam &>(param).setObj(cbcSettings);
  }
...
void addCbcSolverStrParams(CoinParamVec &parameters,
                           CbcSolverSettings *cbcSettings) {
  for (int code = CbcSolverParam::CBCSOLVER_FIRSTSTRPARAM + 1;
       code < CbcSolverParam::CBCSOLVER_LASTSTRPARAM; code++) {
    CoinParam &param = parameters[code];
    static_cast<CbcSolverParam &>(param).setObj(cbcSettings);
    parameters[code].setType(CoinParam::coinParamStr);
  }

  parameters[CbcSolverParam::CSVSTATISTICS].setup(
  ...
  parameters[CbcSolverParam::DEBUG].setup(
  ...
  parameters[CbcSolverParam::DIRECTORY].setup(
  ...
  parameters[CbcSolverParam::DIRSAMPLE].setup(
  ...
  parameters[CbcSolverParam::DIRNETLIB].setup(
  ...
  parameters[CbcSolverParam::DIRMIPLIB].setup(
  ...
  parameters[CbcSolverParam::MIPSTART].setup(
  ...
  parameters[CbcSolverParam::NEXTBESTSOLUTION].setup(
  ...
  parameters[CbcSolverParam::PRINTMASK].setup(
  ...
  parameters[CbcSolverParam::SAVESOL].setup(
  ...
  parameters[CbcSolverParam::SOLUTION].setup(
  ...
  parameters[CbcSolverParam::PRIORITYIN].setup(
...
void addCbcSolverHelpParams(CoinParamVec &parameters,
                            CbcSolverSettings *cbcSettings) {
  for (int code = CbcSolverParam::CBCSOLVER_FIRSTHELPPARAM + 1;
       code < CbcSolverParam::CBCSOLVER_LASTHELPPARAM; code++) {
    parameters[code].setType(CoinParam::coinParamAct);
    parameters[code].setPushFunc(doHelpParam);
  }
  ...
  parameters[CbcSolverParam::HELP].setup(
...
void addCbcSolverActionParams(CoinParamVec &parameters,
                              CbcSolverSettings *cbcSettings) {
  ...
  parameters[CbcSolverParam::BAB].setup(
  ...
  parameters[CbcSolverParam::ENVIRONMENT].setup(
  ...
  parameters[CbcSolverParam::IMPORT].setup(
      "import", "Import model from file", cbcSettings->lastMpsIn_,
  ...
  parameters[CbcSolverParam::UNITTEST].setup(
...
void addCbcSolverKwdParams(CoinParamVec &parameters,
                           CbcSolverSettings *cbcSettings) {
  for (int code = CbcSolverParam::CBCSOLVER_FIRSTKWDPARAM + 1;
       code < CbcSolverParam::CBCSOLVER_LASTKWDPARAM; code++) {
    parameters[code].setType(CoinParam::coinParamKwd);
    parameters[code].setPushFunc(pushCbcSolverKwdParam);
  }

  parameters[CbcSolverParam::ALLCOMMANDS].setup(
      "allC!ommands", "Whether to print less used commands", "off",
      CbcSolverParam::CMOff,
      "For the sake of your sanity, only the more useful and simple commands "
      "are printed out on ?.",
      CoinParam::displayPriorityNone);
  parameters[CbcSolverParam::ALLCOMMANDS].appendKwd("more",
                                                    CbcSolverParam::CMMore);
  parameters[CbcSolverParam::ALLCOMMANDS].appendKwd("all",
                                                    CbcSolverParam::CMAll);

  parameters[CbcSolverParam::CLQSTRENGTHENING].setup(
      "clqstr!engthen",
      "Whether and when to perform Clique Strengthening preprocessing routine",
      "after", CbcSolverParam::ClqStrAfter);
  parameters[CbcSolverParam::CLQSTRENGTHENING].appendKwd(
      "off", CbcSolverParam::ClqStrOff);
  parameters[CbcSolverParam::CLQSTRENGTHENING].appendKwd(
      "before", CbcSolverParam::ClqStrBefore);

  parameters[CbcSolverParam::BRANCHPRIORITY].setup(
  ...
  parameters[CbcSolverParam::BRANCHPRIORITY].appendKwd("pri!orities",
                                                       CbcSolverParam::BPCost);
  parameters[CbcSolverParam::BRANCHPRIORITY].appendKwd("column!Order",
                                                       CbcSolverParam::BPOrder);

  parameters[CbcSolverParam::CUTOFFCONSTRAINT].setup(
  ...
  parameters[CbcSolverParam::CUTOFFCONSTRAINT].appendKwd("on",
                                                         CbcSolverParam::COOn);
  parameters[CbcSolverParam::CUTOFFCONSTRAINT].appendKwd(
      "variable", CbcSolverParam::COVariable);
  parameters[CbcSolverParam::CUTOFFCONSTRAINT].appendKwd(
      "forcevariable", CbcSolverParam::COForceVariable);
  parameters[CbcSolverParam::CUTOFFCONSTRAINT].appendKwd(
      "conflict", CbcSolverParam::COConflict);

  parameters[CbcSolverParam::INTPRINT].setup(
  ...
  parameters[CbcSolverParam::INTPRINT].appendKwd("integer",
                                                 CbcSolverParam::PMInteger);
  parameters[CbcSolverParam::INTPRINT].appendKwd("special",
                                                 CbcSolverParam::PMSpecial);
  parameters[CbcSolverParam::INTPRINT].appendKwd("rows",
                                                 CbcSolverParam::PMRows);
  parameters[CbcSolverParam::INTPRINT].appendKwd("all", CbcSolverParam::PMAll);

  parameters[CbcSolverParam::NODESTRATEGY].setup(
      "node!Strategy",
      ...
      "'fewest'.");
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd("fewest",
                                                     CbcSolverParam::NSFewest);
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd("depth",
                                                     CbcSolverParam::NSDepth);
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd(
      "upfewest", CbcSolverParam::NSUpFewest);
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd(
      "downfewest", CbcSolverParam::NSDownFewest);
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd("updepth",
                                                     CbcSolverParam::NSUpDepth);
  parameters[CbcSolverParam::NODESTRATEGY].appendKwd(
      "downdepth", CbcSolverParam::NSDownDepth);

  parameters[CbcSolverParam::ORBITAL].setup(
  ...
  parameters[CbcSolverParam::ORBITAL].appendKwd("on", CbcSolverParam::OBOn);
  parameters[CbcSolverParam::ORBITAL].appendKwd("slowish",
                                                CbcSolverParam::OBSlowish);
  parameters[CbcSolverParam::ORBITAL].appendKwd("strong",
                                                CbcSolverParam::OBStrong);
  parameters[CbcSolverParam::ORBITAL].appendKwd("force",
                                                CbcSolverParam::OBForce);
  parameters[CbcSolverParam::ORBITAL].appendKwd("simple",
                                                CbcSolverParam::OBSimple);
  parameters[CbcSolverParam::ORBITAL].appendKwd("moreprinting",
                                                CbcSolverParam::OBMorePrinting);

  parameters[CbcSolverParam::PREPROCESS].setup(
      ...
      "CbcStrategy.");
  parameters[CbcSolverParam::PREPROCESS].appendKwd("on", CbcSolverParam::IPPOn);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("save",
                                                   CbcSolverParam::IPPSave);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("equal",
                                                   CbcSolverParam::IPPEqual);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("sos",
                                                   CbcSolverParam::IPPSOS);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("trysos",
                                                   CbcSolverParam::IPPTrySOS);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("equalall",
                                                   CbcSolverParam::IPPEqualAll);
  parameters[CbcSolverParam::PREPROCESS].appendKwd("strategy",
                                                   CbcSolverParam::IPPStrategy);

  parameters[CbcSolverParam::SOSPRIORITIZE].setup(
      ...
      "then SOS in order.");
  parameters[CbcSolverParam::SOSPRIORITIZE].appendKwd("high",
                                                      CbcSolverParam::SOSHigh);
  parameters[CbcSolverParam::SOSPRIORITIZE].appendKwd("low",
                                                      CbcSolverParam::SOSLow);
  parameters[CbcSolverParam::SOSPRIORITIZE].appendKwd(
      "orderhigh", CbcSolverParam::SOSOrderHigh);
  parameters[CbcSolverParam::SOSPRIORITIZE].appendKwd(
      "orderlow", CbcSolverParam::SOSOrderLow);

  parameters[CbcSolverParam::STRATEGY].setup(
      ...
      "feasibility pump more aggressive."); // This does not apply to unit tests
                                            ...
                                            // similar effects)
  parameters[CbcSolverParam::STRATEGY].appendKwd("easy",
                                                 CbcSolverParam::StrategyEasy);
  parameters[CbcSolverParam::STRATEGY].appendKwd(
      "aggressive", CbcSolverParam::StrategyAggressive);

  parameters[CbcSolverParam::TIMEMODE].setup(
  ...
  parameters[CbcSolverParam::TIMEMODE].appendKwd("elapsed",
                                                 CbcSolverParam::ClockElapsed);

  parameters[CbcSolverParam::USECGRAPH].setup(
      "cgraph",
  ...
  parameters[CbcSolverParam::USECGRAPH].appendKwd("off",
                                                  CbcSolverParam::CGraphOff);
  parameters[CbcSolverParam::USECGRAPH].appendKwd("clq",
                                                  CbcSolverParam::CGraphClique);
}

//###########################################################################
//###########################################################################

void addCbcSolverDblParams(CoinParamVec &parameters,
                           CbcSolverSettings *cbcSettings) {
  for (int code = CbcSolverParam::CBCSOLVER_FIRSTDBLPARAM + 1;
       code < CbcSolverParam::CBCSOLVER_LASTDBLPARAM; code++) {
    parameters[code].setType(CoinParam::coinParamDbl);
    parameters[code].setPushFunc(pushCbcSolverDblParam);
  }

  parameters[CbcSolverParam::ARTIFICIALCOST].setup(
      "artif!icialCost",
      "Costs >= this treated as artificials in feasibility pump", 0.0,
      COIN_DBL_MAX, cbcSettings->getArtVarThreshold(), "",
      CoinParam::displayPriorityLow);

  parameters[CbcSolverParam::DEXTRA3].setup(
      "dextra3", "Extra double parameter 3", -COIN_DBL_MAX, COIN_DBL_MAX, 0.0,
      "", CoinParam::displayPriorityNone);

  parameters[CbcSolverParam::DEXTRA4].setup(
      "dextra4", "Extra double parameter 4", -COIN_DBL_MAX, COIN_DBL_MAX, 0.0,
      "", CoinParam::displayPriorityNone);

  parameters[CbcSolverParam::DEXTRA5].setup(
      "dextra5", "Extra double parameter 5", -COIN_DBL_MAX, COIN_DBL_MAX, 0.0,
      "", CoinParam::displayPriorityNone);

  parameters[CbcSolverParam::DJFIX].setup(
  ...
  parameters[CbcSolverParam::FAKECUTOFF].setup(
  ...
  parameters[CbcSolverParam::FAKEINCREMENT].setup(
  ...
  parameters[CbcSolverParam::SMALLBAB].setup(
  ...
  parameters[CbcSolverParam::TIGHTENFACTOR].setup(
      "tighten!Factor",
...
void addCbcSolverIntParams(CoinParamVec &parameters,
                           CbcSolverSettings *cbcSettings) {
  for (int code = CbcSolverParam::CBCSOLVER_FIRSTINTPARAM + 1;
       code < CbcSolverParam::CBCSOLVER_LASTINTPARAM; code++) {
    parameters[code].setType(CoinParam::coinParamInt);
    parameters[code].setPushFunc(pushCbcSolverIntParam);
  }

  parameters[CbcSolverParam::BKPIVOTINGSTRATEGY].setup(
      "bkpivot!ing", "Pivoting strategy used in Bron-Kerbosch algorithm", 0, 6,
      3);

  parameters[CbcSolverParam::BKMAXCALLS].setup(
      "bkmaxcalls",
      "Maximum number of recursive calls made by Bron-Kerbosch algorithm", 1,
      COIN_INT_MAX, 1000);

  parameters[CbcSolverParam::BKCLQEXTMETHOD].setup(
      "bkclqext!method",
  ...
  parameters[CbcSolverParam::CPP].setup(
  ...
  parameters[CbcSolverParam::CUTDEPTH].setup(
      "cutD!epth", "Depth in tree at which to do cuts", -1, 999999,
      cbcSettings->getCutDepth(),
  ...
  parameters[CbcSolverParam::CUTLENGTH].setup(
  ...
  parameters[CbcSolverParam::CUTPASSINTREE].setup(
      "passT!reeCuts",
      "Number of rounds that cut generators are applied in the tree",
      -COIN_INT_MAX, COIN_INT_MAX);

  parameters[CbcSolverParam::DEPTHMINIBAB].setup(
  ...
  parameters[CbcSolverParam::DIVEOPT].setup(
  ...
  parameters[CbcSolverParam::DIVEOPTSOLVES].setup(
  ...
  parameters[CbcSolverParam::EXPERIMENT].setup(
  ...
  parameters[CbcSolverParam::FPUMPTUNE2].setup(
  ...
  parameters[CbcSolverParam::HEUROPTIONS].setup(
  ...
  parameters[CbcSolverParam::LOGLEVEL].setup(
      "log!Level", "Level of detail in CBC output.", -1, 999999,
      cbcSettings->getLogLevel(),
  ...
  parameters[CbcSolverParam::LPLOGLEVEL].setup(
      "log!Level", "Level of detail in LP solver output.", -1, 999999,
      cbcSettings->getLpLogLevel(),
      "If set to 0 then there should be no output in normal circumstances. A "
      "value of 1 is probably the best value for most uses, while 2 and 3 give "
      "more information.");

  parameters[CbcSolverParam::MAXSAVEDSOLS].setup(
      "maxSaved!Solutions", "Maximum number of solutions to save", 0,
      COIN_INT_MAX, 1, "Number of solutions to save.");

  parameters[CbcSolverParam::MAXSLOWCUTS].setup(
  ...
  parameters[CbcSolverParam::ODDWEXTMETHOD].setup(
      "oddwext!method",
  ...
  parameters[CbcSolverParam::OUTPUTFORMAT].setup(
  ...
  parameters[CbcSolverParam::PRINTOPTIONS].setup(
  ...
  parameters[CbcSolverParam::PROCESSTUNE].setup(
  ...
  parameters[CbcSolverParam::RANDOMSEED].setup(
  ...
  parameters[CbcSolverParam::STRONGSTRATEGY].setup(
  ...
  parameters[CbcSolverParam::TESTOSI].setup("testO!si", "Test OsiObject stuff",
                                            -1, COIN_INT_MAX, -1, "",
                                            CoinParam::displayPriorityNone);

#ifdef CBC_THREAD
  parameters[CbcSolverParam::THREADS].setup(
  ...
  parameters[CbcSolverParam::USERCBC].setup(
...
void addCbcSolverBoolParams(CoinParamVec &parameters,
                            CbcSolverSettings *cbcSettings) {
  for (int code = CbcSolverParam::CBCSOLVER_FIRSTBOOLPARAM + 1;
       code < CbcSolverParam::CBCSOLVER_LASTBOOLPARAM; code++) {
    parameters[code].setType(CoinParam::coinParamKwd);
    parameters[code].appendKwd("off", CbcSolverParam::ParamOff);
    parameters[code].appendKwd("on", CbcSolverParam::ParamOn);
    parameters[code].setPushFunc(pushCbcSolverKwdParam);
  }

  parameters[CbcSolverParam::CPX].setup(
  ...
  parameters[CbcSolverParam::DOHEURISTIC].setup(
      "doH!euristic", "Do heuristics before any preprocessing", "off",
      cbcSettings->getDiveCoefficientMode(),
  ...
  parameters[CbcSolverParam::ERRORSALLOWED].setup(
  ...
  parameters[CbcSolverParam::EXTRAVARIABLES].setup(
  ...
  parameters[CbcSolverParam::MESSAGES].setup(
  ...
  parameters[CbcSolverParam::PREPROCNAMES].setup(
  ...
  parameters[CbcSolverParam::SOS].setup(
  ...
  parameters[CbcSolverParam::USESOLUTION].setup(
...
void addCbcSolverCutParams(CoinParamVec &parameters,
                           CbcSolverSettings *cbcSettings) {
  ...
  parameters[CbcSolverParam::CLIQUECUTS].setup(
  ...
  parameters[CbcSolverParam::CUTSTRATEGY].setup(
  ...
  parameters[CbcSolverParam::FLOWCUTS].setup(
  ...
  parameters[CbcSolverParam::KNAPSACKCUTS].setup(
  ...
  parameters[CbcSolverParam::LANDPCUTS].setup(
  ...
  parameters[CbcSolverParam::LAGOMORYCUTS].setup(
      "lagomory!Cuts", "Whether to use Lagrangean Gomory cuts", "off",
      cbcSettings->getLaGomoryMode(),
  ...
  parameters[CbcSolverParam::ODDWHEELCUTS].setup(
      "oddwheel!Cuts", "Whether to use odd wheel cuts", "off",
      cbcSettings->getOddWheelMode(),
      "This switches on odd-wheel inequalities (either at root or in entire "
      "tree).");

  parameters[CbcSolverParam::PROBINGCUTS].setup(
  ...
  parameters[CbcSolverParam::REDSPLITCUTS].setup(
  ...
  parameters[CbcSolverParam::ZEROHALFCUTS].setup(
      "zero!HalfCuts", "Whether to use zero half cuts", "off",
      cbcSettings->getZeroHalfMode(),
  ...
  for (int code = CbcSolverParam::CBCSOLVER_FIRSTCUTPARAM + 1;
    ...
    default: { break; }
      ...
      case CbcSolverParam::GOMORYCUTS: {
        ...
        parameters[code].appendKwd("forcelongon",
                                   CbcSolverParam::CGForceLongOn);
      ...
      case CbcSolverParam::GMICUTS: {
        ...
        parameters[code].appendKwd("forcelongon",
                                   CbcSolverParam::CGForceLongOn);
        parameters[code].appendKwd("longendonly",
                                   CbcSolverParam::CGLongEndOnly);
        break;
      }
      ...
      case CbcSolverParam::LATWOMIRCUTS: {
        parameters[code].appendKwd("endonlyroot",
                                   CbcSolverParam::CGEndOnlyRoot);
        parameters[code].appendKwd("endcleanroot",
                                   CbcSolverParam::CGEndCleanRoot);
        ...
        parameters[code].appendKwd("cleanaswell",
                                   CbcSolverParam::CGCleanAsWell);
        parameters[code].appendKwd("bothaswell", CbcSolverParam::CGBothAsWell);
        parameters[code].appendKwd("onlyinstead",
                                   CbcSolverParam::CGOnlyInstead);
        parameters[code].appendKwd("cleaninstead",
                                   CbcSolverParam::CGCleanInstead);
        parameters[code].appendKwd("bothinstead",
                                   CbcSolverParam::CGBothInstead);
        break;
      }
      case CbcSolverParam::ODDWHEELCUTS: {
        parameters[code].appendKwd("onglobal", CbcSolverParam::CGOnGlobal);
...
void addCbcSolverHeurParams(CoinParamVec &parameters,
                            CbcSolverSettings *cbcSettings) {
  ...
  parameters[CbcSolverParam::COMBINE].setup(
      "combine!Solutions", "Whether to use combine solution heuristic", "off",
      cbcSettings->getCombineMode(),
  ...
  parameters[CbcSolverParam::CROSSOVER].setup(
      "combine2!Solutions", "Whether to use crossover solution heuristic",
      "off", cbcSettings->getCrossoverMode());

  parameters[CbcSolverParam::DINS].setup(
      "Dins", "Whether to try Distance Induced Neighborhood Search", "off",
      cbcSettings->getDinsMode(), HEURISTICS_LONGHELP);

  parameters[CbcSolverParam::DIVINGC].setup(
      "DivingC!oefficient", "Whether to try Coefficient diving heuristic",
      "off", cbcSettings->getDiveCoefficientMode(), HEURISTICS_LONGHELP);

  parameters[CbcSolverParam::DIVINGF].setup(
      "DivingF!ractional", "Whether to try Fractional diving heuristic", "off",
      cbcSettings->getDiveFractionalMode(), HEURISTICS_LONGHELP);

  parameters[CbcSolverParam::DIVINGG].setup(
      "DivingG!uided", "Whether to try Guided diving heuristic", "off",
      cbcSettings->getDiveGuidedMode(), HEURISTICS_LONGHELP);

  parameters[CbcSolverParam::DIVINGL].setup(
      "DivingL!ineSearch", "Whether to try Linesearch diving heuristic", "off",
      cbcSettings->getDiveLineSearchMode(), HEURISTICS_LONGHELP);

  parameters[CbcSolverParam::DIVINGP].setup(
      "DivingP!seudocost", "Whether to try Pseudocost diving heuristic", "off",
      cbcSettings->getDivePseudocostMode(), HEURISTICS_LONGHELP);

  parameters[CbcSolverParam::DIVINGS].setup(
      "DivingS!ome", "Whether to try Diving heuristics", "off",
      cbcSettings->getDiveRandomMode(),
  ...
  parameters[CbcSolverParam::GREEDY].setup(
  ...
  parameters[CbcSolverParam::HEURISTICSTRATEGY].setup(
  ...
  parameters[CbcSolverParam::PROXIMITY].setup(
      "proximity!Search", "Whether to do proximity search heuristic", "off",
      cbcSettings->getProximityMode(),
  ...
  parameters[CbcSolverParam::LOCALTREE].setup(
  ...
  parameters[CbcSolverParam::VND].setup(
      "Vnd!VariableNeighborhoodSearch",
      "Whether to try Variable Neighborhood Search", "off",
      cbcSettings->getVndMode(), HEURISTICS_LONGHELP);
  ...
  for (int code = CbcSolverParam::CBCSOLVER_FIRSTHEURPARAM + 1;
    ...
    case CbcSolverParam::RENS: {
      ...
      parameters[code].appendKwd("usesolution",
                                 CbcSolverParam::HeurUseSolution);
      break;
    }
    case CbcSolverParam::RINS: {
      parameters[code].appendKwd("often", CbcSolverParam::HeurOften);
...

{
  ...
  for (unsigned i = 0; i < paramVec.size(); i++) {
    if (paramVec[i].pushFunc() == 0) {
      if (unimpCnt % maxAcross == 0) {
        std::cout << std::endl;
      } else {
        std::cout << " ";
      }
      std::cout << paramVec[i].name();
      unimpCnt++;
    }
  }
...

{
  ...
  std::cout << "cbc-generic is experimental software. If you want a stable MIP "
...

{
  ...
  CbcSolverParam::CbcSolverParamCode code = cbcParam.paramCode();
  ...
  std::string pfx("  ");
  CoinParamUtils::printHelp(*paramVec, 0, paramVec->size() - 1, pfx, shortHelp,
                            longHelp, hidden);
