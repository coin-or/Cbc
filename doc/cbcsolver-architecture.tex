...
\begin{tikzpicture}[
  ...
  % ================= Edges: dispatcher fan-out (staggered elbow heights so each =================
  % branch is visually distinct right below the rundeque hub, ordered by target x) =================
  \draw[otharr] (rundeque.south) -- ++(0,-1.8) -| (imppriv.north);
  \draw[otharr] (rundeque.south) -- ++(0,-1.5) -| (boundprop.north);
  \draw[otharr] (rundeque.south) -- ++(0,-1.2) -| (checksol.north);
  \draw[otharr] (rundeque.south) -- ++(0,-0.9) -| (writesol.north);
  \draw[otharr] (rundeque.south) -- ++(0,-0.6) -| (applylp.north);
  \draw[babarr] (rundeque.south) -- ++(0,-0.3) -| (babcase.north);
