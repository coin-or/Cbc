...
\subsubsection*{\texttt{-feasibilityJump}}
\addcontentsline{toc}{subsubsection}{\texttt{-feasibilityJump}}
...
\subsubsection*{\texttt{-fpFixingMode}}
\addcontentsline{toc}{subsubsection}{\texttt{-fpFixingMode}}
...
\textbf{Values:} \texttt{off}, \texttt{intBounds}, \texttt{allIntegral}, \texttt{continuousBounds}, \texttt{staticContinuous}, \texttt{noInternalInts}, \texttt{slackBasis} (default: \texttt{continuousBounds})

\subsubsection*{\texttt{-fpAccumulate}}
\addcontentsline{toc}{subsubsection}{\texttt{-fpAccumulate}}
...
\subsubsection*{\texttt{-fpRunMode}}
\addcontentsline{toc}{subsubsection}{\texttt{-fpRunMode}}
...
\textbf{Values:} \texttt{normal}, \texttt{twice}, \texttt{afterRootCuts}, \texttt{alwaysTwice} (default: \texttt{normal})
...
\subsubsection*{\texttt{-feasibilityJumpEffort}}
\addcontentsline{toc}{subsubsection}{\texttt{-feasibilityJumpEffort}}

Iteration budget for the Feasibility Jump heuristic

Maximum effort (deterministic iteration units) spent in a single Feasibility Jump call. The internal effort counter grows by O(problem nonzeros) per inner step, making this budget independent of CPU speed. Default: 10000000 (\textasciitilde{}10 million units). Increase for harder instances; decrease to limit overhead at the root node.

\textbf{Range:} 0 to INT\_MAX (default: 10000000)

\subsubsection*{\texttt{-feasibilityJumpMaxSol}}
\addcontentsline{toc}{subsubsection}{\texttt{-feasibilityJumpMaxSol}}
...
\textbf{Range:} 0 to INT\_MAX (default: 1)
...
\subsubsection*{\texttt{-fpRetries}}
\addcontentsline{toc}{subsubsection}{\texttt{-fpRetries}}
...
\textbf{Range:} 0 to 999 (default: 5)

\subsubsection*{\texttt{-fpOptions}}
\addcontentsline{toc}{subsubsection}{\texttt{-fpOptions}}
...
\textbf{Range:} 0 to 9 (default: 4)

\subsubsection*{\texttt{-fpMaxPassesWithoutChange}}
\addcontentsline{toc}{subsubsection}{\texttt{-fpMaxPassesWithoutChange}}
...
Controls which LP algorithm is used when -solve or -initialSolve triggers the root LP relaxation.
  auto:    ML-based automatic selection (default). Random Forest trained
           on 380 instances; \textasciitilde{}1.33x speedup over dual on benchmark set.
  dual:    dual simplex.
  primal:  primal simplex.
  barrier: interior-point (barrier) method.

\textbf{Values:} \texttt{dual}, \texttt{primal}, \texttt{barrier}, \texttt{auto} (default: \texttt{auto})
...
When enabled, the root LP relaxation is solved by racing multiple LP method configurations in parallel. The first to reach optimality wins and the others are aborted. The number of racing threads is taken from the -threads parameter: 2 threads uses the K=2 portfolio (dual\_pesteep\_pertv75 + primal\_idiot50, \textasciitilde{}1.51x speedup); 3 or more threads uses the K=3 portfolio (dual\_pesteep\_psineg1\_pertv75 + primal\_idiot50 + primal\_sprint, \textasciitilde{}1.63x speedup). Portfolios are data-driven from k-fold cross-validation on MIPLIB 2017+SPP.
...
\textbf{Range:} 1 to INT\_MAX (default: 6)
...
\textbf{Values:} \texttt{off}, \texttt{before}, \texttt{after}, \texttt{both} (default: \texttt{before})
...
\subsection*{\texttt{-preProbing}}
\addcontentsline{toc}{subsection}{\texttt{-preProbing}}
...
\textbf{Values:} \texttt{off}, \texttt{heavy}, \texttt{heavier} (default: \texttt{off})

\subsection*{\texttt{-preIntegerize}}
\addcontentsline{toc}{subsection}{\texttt{-preIntegerize}}
...
\textbf{Values:} \texttt{off}, \texttt{objective}, \texttt{always} (default: \texttt{off})

\subsection*{\texttt{-preCliques}}
\addcontentsline{toc}{subsection}{\texttt{-preCliques}}
...
\subsection*{\texttt{-preDominatedRows}}
\addcontentsline{toc}{subsection}{\texttt{-preDominatedRows}}
...
\subsection*{\texttt{-preLargeFeasibilityTolerance}}
\addcontentsline{toc}{subsection}{\texttt{-preLargeFeasibilityTolerance}}
...
\subsection*{\texttt{-preProbingBeforeCliques}}
\addcontentsline{toc}{subsection}{\texttt{-preProbingBeforeCliques}}
...
\subsection*{\texttt{-preMajorPasses}}
\addcontentsline{toc}{subsection}{\texttt{-preMajorPasses}}
...
\subsection*{\texttt{-preminorPasses}}
\addcontentsline{toc}{subsection}{\texttt{-preminorPasses}}
