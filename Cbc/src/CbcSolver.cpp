                ...
                if (type == CBC_PARAM_GENERALQUERY) {
                    ...
                    case CBC_PARAM_ACTION_DOHEURISTIC:
                        if (goodModel) {
                            ...
                            doHeuristics(&model_, 2, parameters_, numberParameters_, noPrinting_, initialPumpTune);
                    ...
                    case CBC_PARAM_ACTION_BAB: // branchAndBound
                        ...
                        if (goodModel) {
                            ...
                            // Set up heuristics
                            doHeuristics(babModel_, (!miplib) ? 1 : 10, parameters_, numberParameters_, noPrinting_, initialPumpTune);
                            if (!miplib) {
