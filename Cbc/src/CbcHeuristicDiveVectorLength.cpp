...
void 
CbcHeuristicDiveVectorLength::resetModel(CbcModel * model)
{
  model_=model;
  // Get a copy of original matrix
...
int
CbcHeuristicDiveVectorLength::solution(double & solutionValue,
				     double * betterSolution)
{
  ...
  if (newSolutionValue<solutionValue) {
    ...
    if (feasible) {
      ...
      //printf("** Solution of %g found by CbcHeuristicDiveVectorLength\n",newSolutionValue);
      returnCode=1;
    } else {
      // Can easily happen
      //printf("Debug CbcHeuristicDiveVectorLength giving bad solution\n");
    }
  }
...
// update model
void CbcHeuristicDiveVectorLength::setModel(CbcModel * model)
{
  model_ = model;
...
void 
CbcHeuristicDiveVectorLength::validate() 
{
  if (model_&&when()<10) {
