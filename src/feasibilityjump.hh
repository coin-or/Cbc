// This file is a reference-implementation header for the Feasibility Jump
// local-search primal heuristic:
//   Copyright (c) 2022 SINTEF. Licensed under the MIT License.
// See: Leitner, Fischetti, Toth (2023), "Feasibility Jump",
//   Mathematical Programming Computation.
//   https://link.springer.com/article/10.1007/s12532-023-00234-8
//
// Ported into Cbc unmodified (originally ported into MIPster, a CBC fork,
// then carried over into upstream Cbc here) as a standalone, dependency-free
// local-search engine invoked by CbcHeuristicFeasibilityJump.
...
{
    int64_t totalEffort;
    int64_t effortSinceLastImprovement;
    int numVars;
