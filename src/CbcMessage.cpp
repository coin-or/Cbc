...
static Cbc_message us_english[] = {
  ...
  { CBC_SOLUTION, 4, 1, "Integer solution of %.13g found after %d iterations and %d nodes %d depth %d ontree (%.2f seconds)" },
  ...
  { CBC_MAXNODES, 3, 1, "Exiting on maximum nodes" },
  { CBC_SOLUTION, 4, 1, "Integer solution of %.13g found after %ld iterations and %ld nodes %d depth %d ontree (%.2f seconds)" },
  ...
  { CBC_MAXMEMORY, 52, 1, "Exiting on maximum memory usage" },
