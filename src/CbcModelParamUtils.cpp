...

{
  ...
  param = new CbcModelParam(CbcModelParam::ALLOWABLEGAP,
    ...
    0.0, 1.0e20);
  param->setDblVal(0.0);
  param->setPushFunc(pushCbcModelDblParam);
  param->setObj(model);
  param->setLongHelp(
  ...
  param->setPushFunc(pushCbcModelIntParam);
  param->setObj(model);
  param->setLongHelp(
  ...
  param = new CbcModelParam(CbcModelParam::MAXNODESNOTIMPROVING, "maxNNI!FS",
  ...
  param = new CbcModelParam(CbcModelParam::MAXSECONDSNOTIMPROVING, "secni!fs",
  ...
  param = new CbcModelParam(CbcModelParam::MAXSOLS, "maxSo!lutions",
  ...
  param = new CbcModelParam(CbcModelParam::MIPOPTIONS, "mipO!ptions",
                            "Dubious options for mip", 0, COIN_INT_MAX, 0,
                            CoinParam::displayPriorityNone);
  parameters.push_back(param);

  param = new CbcModelParam(CbcModelParam::MOREMIPOPTIONS, "more!MipOptions",
                            "More dubious options for mip", -1, COIN_INT_MAX, 0,
                            CoinParam::displayPriorityNone);
  parameters.push_back(param);

#if 0
  param = new CbcModelParam(CbcModelParam::NUMBERMINI, "miniT!ree",
  ...
  param = new CbcModelParam(CbcModelParam::NUMBERANALYZE, "numberA!nalyze",
  ...
  param = new CbcModelParam(CbcModelParam::TIMELIMIT,
