...

{
  ...
  parameters[CbcModelParam::ALLOWABLEGAP].setup("allow!ableGap",
  ...
  parameters[CbcModelParam::CUTOFF].setup("cuto!ff",
  ...
  parameters[CbcModelParam::DIRECTION].setup("direction",
  ...
  parameters[CbcModelParam::INCREMENT].setup("inc!rement",
  ...
  parameters[CbcModelParam::INFEASIBILITYWEIGHT].setup("inf!easibilityWeight",
  ...
  parameters[CbcModelParam::INTEGERTOLERANCE].setup("integerT!olerance",
  ...
  parameters[CbcModelParam::LOGLEVEL].setup("bclog!Level",
  ...
  parameters[CbcModelParam::MAXIMIZE].setup("max!imize",
  ...
  parameters[CbcModelParam::MAXNODES].setup("maxN!odes",
  ...
  parameters[CbcModelParam::MAXNODESNOTIMPROVING].setup("maxNNI!FS",
  ...
  parameters[CbcModelParam::MAXSECONDSNOTIMPROVING].setup("secni!fs",
  ...
  parameters[CbcModelParam::MAXSOLS].setup("maxSo!lutions",
  ...
  parameters[CbcModelParam::MINIMIZE].setup("min!imize",
  ...
  parameters[CbcModelParam::MIPOPTIONS].setup("mipO!ptions",
                                               "Dubious options for mip", 0, COIN_INT_MAX, 0, "",
                                               CoinParam::displayPriorityNone);
  
  parameters[CbcModelParam::MOREMIPOPTIONS].setup("more!MipOptions",
  ...
  parameters[CbcModelParam::NUMBERANALYZE].setup("numberA!nalyze",
  ...
  parameters[CbcModelParam::CUTPASS].setup("passC!uts",
  ...
  parameters[CbcModelParam::GAPRATIO].setup("ratio!Gap",
  ...
  parameters[CbcModelParam::TIMELIMIT].setup("sec!onds",
  ...
  parameters[CbcModelParam::STRONGBRANCHING].setup("strong!Branching",
  ...
  parameters[CbcModelParam::NUMBERBEFORE].setup("trust!PseudoCosts",
