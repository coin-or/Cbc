#!/usr/bin/env python3
"""Generate an HTML parameter reference page from 'cbc -dumpParameters' JSON.

Usage:
    python3 doc/generate_html_reference.py [path/to/cbc] > docs/parameters.html
"""
...
<head>
  ...
  <title>CBC \u2014 Parameter Reference</title>
  <style>
{CSS}  </style>
</head>
<body>
...
<nav class="topnav">
  <a class="nav-brand" href="https://github.com/coin-or/Cbc">COIN-OR CBC</a>
  <div class="nav-links">
    <a href="parameters.html" style="color:var(--text)">Parameters</a>
    <a href="https://github.com/coin-or/Cbc">GitHub</a>
  </div>
</nav>
...
{sidebar_links}
  ...
  <div class="main-content">
    <header class="page-header">
      ...
      <p>CBC {escape(version)} &mdash; {escape(date)} &mdash; {total} parameters across {len(order)} sections</p>
    </header>
...
<footer>
  <p>CBC is the COIN-OR Branch and Cut MIP solver
  &middot; Licensed under <a href="https://github.com/coin-or/Cbc/blob/master/LICENSE">EPL-2.0</a>
  &middot; <a href="https://github.com/coin-or/Cbc">GitHub</a></p>
</footer>
