...
\textbf{Values:} \texttt{off}, \texttt{before}, \texttt{after}, \texttt{both} (default: \texttt{after})
...
\textbf{Values:} \texttt{dual}, \texttt{primal}, \texttt{barrier}, \texttt{auto}, \texttt{racing}, \texttt{recommend} (default: \texttt{auto})
